...
import AboutImage from "../assets/images/CodePic1.jpg";
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="flex-1">
            <p className="text-lg mb-8 font-mono">
              I'm a passionate web developer with a focus on building modern and
            ...
            <div className="mt-12 flex justify-between text-center"></div>
          </div>
        </div>
      </div>
    </div>
